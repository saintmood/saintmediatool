...
class ImageRetriveTestCase(BaseTestCase):
    ...
    def test_retrive_single_image_success(self):
        ...
        self.assertIsNotNone(resp_json['data']['picture_urls']['small_url'])
        self.assertIsNotNone(resp_json['data']['picture_urls']['medium_url'])
        self.assertIsNotNone(resp_json['data']['picture_urls']['large_url'])
